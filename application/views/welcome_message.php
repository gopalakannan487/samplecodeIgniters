                ...
                <div class="features_wrapper">
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-4 features_col">
                            <div class="single_features text-center">
                                <div class="features_icon">
                                    <img src="<?php echo base_url('')?>/assets/images/f-icon-1.png" alt="Icon" />
                                </div>
                        ...
                        <div class="col-md-4 features_col">
                            <div class="single_features text-center">
                                <div class="features_icon">
                                    <img src="<?php echo base_url('')?>/assets/images/f-icon-2.png" alt="Icon" />
                                </div>
                                <div class="features_content">
                        ...
                        <div class="col-md-4 features_col">
                            <div class="single_features text-center">
                                <div class="features_icon">
                                    <img src="<?php echo base_url('')?>/assets/images/f-icon-3.png" alt="Icon" />
                                </div>
                                <div class="features_content">
        ...
        <section class="about_area pt-80">
            <img class="shap_1" src="<?php echo base_url('')?>/assets/images/shape/shape-1.png" alt="shape" />
            <img class="shap_2" src="<?php echo base_url('')?>/assets/images/shape/shape-2.png" alt="shape" />
            <img class="shap_3" src="<?php echo base_url('')?>/assets/images/shape/shape-3.png" alt="shape" />
            <img class="shap_4" src="<?php echo base_url('')?>/assets/images/shape/shape-4.png" alt="shape" />
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="about_image mt-50">
                            <img src="<?php echo base_url('')?>/assets/images/about-1.jpg" alt="about" class="about_image-1" />
                            <img src="<?php echo base_url('')?>/assets/images/about-2.jpg" alt="about" class="about_image-2" />
                            <img src="<?php echo base_url('')?>/assets/images/about-3.jpg" alt="about" class="about_image-3" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row counter_wrapper">
                        ...
                        <div class="single_counter text-center mt-50">
                            <div class="counter_icon">
                                <div class="icon_wrapper">
                                    <img src="<?php echo base_url('')?>/assets/images/count_icon-1.png" alt="Icon" />
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 counter_col">
                        <div class="single_counter text-center mt-50">
                            <div class="counter_icon">
                                <div class="icon_wrapper">
                                    <img src="<?php echo base_url('')?>/assets/images/count_icon-2.png" alt="Icon" />
                                </div>
                            </div>
                            <div class="counter_content">
                    ...
                    <div class="col-lg-3 col-sm-6 counter_col">
                        <div class="single_counter text-center mt-50">
                            <div class="counter_icon">
                                <div class="icon_wrapper">
                                    <img src="<?php echo base_url('')?>/assets/images/count_icon-3.png" alt="Icon" />
                                </div>
                            </div>
                            <div class="counter_content">
                    ...
                    <div class="col-lg-3 col-sm-6 counter_col">
                        <div class="single_counter text-center mt-50">
                            <div class="counter_icon">
                                <div class="icon_wrapper">
                                    <img src="<?php echo base_url('')?>/assets/images/count_icon-4.png" alt="Icon" />
                                </div>
                            </div>
                            <div class="counter_content">
                ...
                <div class="row no-gutters program_wrapper">
                    <div class="col-lg-4 col-md-6 program_col">
                        <div class="single_program program_color-1 d-flex flex-wrap">
                            <div class="program_icon">
                                <div class="icon_wrapper">
                                    <img src="<?php echo base_url('')?>/assets/images/p-icon-1.png" alt="Icon" />
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 program_col">
                        <div class="single_program program_color-2 d-flex flex-wrap program_4">
                            <div class="program_icon">
                                <div class="icon_wrapper">
                                    <img src="<?php echo base_url('')?>/assets/images/p-icon-2.png" alt="Icon" />
                                </div>
                            </div>
                            <div class="program_content">
                                <div class="content_wrapper">
                    ...
                    <div class="col-lg-4 col-md-6 program_col">
                        <div class="single_program program_color-3 d-flex flex-wrap program_3">
                            <div class="program_icon">
                                <div class="icon_wrapper">
                                    <img src="<?php echo base_url('')?>/assets/images/p-icon-3.png" alt="Icon" />
                                </div>
                            </div>
                            <div class="program_content">
                                <div class="content_wrapper">
                    ...
                    <div class="col-lg-4 col-md-6 program_col">
                        <div class="single_program program_color-4 d-flex flex-wrap program_2 program_3 program_4">
                            <div class="program_icon">
                                <div class="icon_wrapper">
                                    <img src="<?php echo base_url('')?>/assets/images/p-icon-4.png" alt="Icon" />
                                </div>
                            </div>
                            <div class="program_content">
                                <div class="content_wrapper">
                    ...
                    <div class="col-lg-4 col-md-6 program_col">
                        <div class="single_program program_color-5 d-flex flex-wrap program_2">
                            <div class="program_icon">
                                <div class="icon_wrapper">
                                    <img src="<?php echo base_url('')?>/assets/images/p-icon-5.png" alt="Icon" />
                                </div>
                            </div>
                            <div class="program_content">
                                <div class="content_wrapper">
                    ...
                    <div class="col-lg-4 col-md-6 program_col">
                        <div class="single_program program_color-6 d-flex flex-wrap program_2 program_4">
                            <div class="program_icon">
                                <div class="icon_wrapper">
                                    <img src="<?php echo base_url('')?>/assets/images/p-icon-6.png" alt="Icon" />
                                </div>
                            </div>
                            <div class="program_content">
                                <div class="content_wrapper">
        ...
        <section class="why_choose_area pt-120 pb-130">
                        ...
                        <div class="why_choose_content">
                            ...
                            <div class="row">
                                <div class="col-sm-6 choose_col">
                                    <div class="single_choose mt-30">
                                        <div class="choose_icon">
                                            <img src="<?php echo base_url('')?>/assets/images/choose_icon-1.png" alt="Icon" />
                                        </div>
                                ...
                                <div class="col-sm-6 choose_col">
                                    <div class="single_choose mt-30">
                                        <div class="choose_icon">
                                            <img src="<?php echo base_url('')?>/assets/images/choose_icon-2.png" alt="Icon" />
                                        </div>
                                        <div class="choose_content">
                                ...
                                <div class="col-sm-6 choose_col">
                                    <div class="single_choose mt-30">
                                        <div class="choose_icon">
                                            <img src="<?php echo base_url('')?>/assets/images/choose_icon-3.png" alt="Icon" />
                                        </div>
                                        <div class="choose_content">
                                ...
                                <div class="col-sm-6 choose_col">
                                    <div class="single_choose mt-30">
                                        <div class="choose_icon">
                                            <img src="<?php echo base_url('')?>/assets/images/choose_icon-4.png" alt="Icon" />
                                        </div>
                                        <div class="choose_content">
            ...
            <div class="why_choose_image d-none d-lg-table">
                <div class="image">
                    <img src="<?php echo base_url('')?>/assets/images/choose_bg.png" alt="" />
                </div>
            </div>
        </section>
        ...
        <section class="courses_area courses_bg pt-120 pb-130">
            <img class="shape-1" src="<?php echo base_url('')?>/assets/images/shape/shape-1.png" alt="shape" />
            <img class="shape-2" src="<?php echo base_url('')?>/assets/images/shape/shape-2.png" alt="shape" />
            <img class="shape-3" src="<?php echo base_url('')?>/assets/images/shape/shape-3.png" alt="shape" />
            <img class="shape-4" src="<?php echo base_url('')?>/assets/images/shape/shape-4.png" alt="shape" />
            <img class="shape-5" src="<?php echo base_url('')?>/assets/images/shape/shape-5.png" alt="shape" />
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="single_courses mt-30">
                            <div class="courses_image">
                                <img src="<?php echo base_url('')?>/assets/images/courses-1.jpg" alt="courses" />
                            </div>
                            <div class="courses_content">
                                ...
                                <div class="courses_author d-flex">
                                    <div class="author_image">
                                        <img src="<?php echo base_url('')?>/assets/images/author-1.jpg" alt="author" />
                                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single_courses mt-30">
                            <div class="courses_image">
                                <img src="<?php echo base_url('')?>/assets/images/courses-2.jpg" alt="courses" />
                            </div>
                            <div class="courses_content">
                                <ul class="tag">
                                ...
                                <div class="courses_author d-flex">
                                    <div class="author_image">
                                        <img src="<?php echo base_url('')?>/assets/images/author-2.jpg" alt="author" />
                                    </div>
                                    <div class="author_name media-body">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single_courses mt-30">
                            <div class="courses_image">
                                <img src="<?php echo base_url('')?>/assets/images/courses-3.jpg" alt="courses" />
                            </div>
                            <div class="courses_content">
                                <ul class="tag">
                                ...
                                <div class="courses_author d-flex">
                                    <div class="author_image">
                                        <img src="<?php echo base_url('')?>/assets/images/author-3.jpg" alt="author" />
                                    </div>
                                    <div class="author_name media-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="testimonial_title mt-50">
                            <img src="<?php echo base_url('')?>/assets/images/quota.png" alt="quota" />
                ...
                <div class="row no-gutters">
                    <div class="col-lg-6 team_col_1">
                        <div class="single_team d-sm-flex flex-wrap align-items-center">
                            <img class="team_arrow" src="<?php echo base_url('')?>/assets/images/left.png" alt="left" />
                        ...
                        <div class="single_team d-sm-flex flex-wrap align-items-center flex-row-reverse">
                            <img class="team_arrow" src="<?php echo base_url('')?>/assets/images/right.png" alt="left" />
                            <div class="team_image">
    ...
    <?php foreach ($events as $event) { 
        ...
        // echo '<pre>';print_r($event['formatted_date']);exit();
        ?>
                    ...
                    <div class="col-lg-4 col-md-7">
                        <div class="single_blog mt-30">
                            <div class="blog_image">
                                <img src="<?php echo base_url('')?>/uploads/events/<?php echo $event['event_image'];?>" alt="blog" />
                            </div>
                            <div class="blog_content">
                                         <?php
                    // Extract day and month from the formatted_date (e.g., "25 Feb 2025")
                    $dateParts = explode(' ', $event['formatted_date']);
                    ?>
                    <span class="date"><span><?php echo $dateParts[0]; ?></span> <?php echo $dateParts[1]; ?></span>

                                

                                <div class="blog_content_wrapper">
                                    <ul class="blog_meta">
                                        <li><a href="#"><?php echo $event['event_title'];?></a></li>
                                        <li><a href="#"><?php echo $event['formatted_date'];?></a></li>
                                    </ul>
                                    <h4 class="blog_title"><a href="#"><?php echo $event['event_description'];?></a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php } ?>
 ...
 <!--                    <div class="col-lg-4 col-md-7">
                        <div class="single_blog mt-30">
                            <div class="blog_image">
                                <img src="<?php echo base_url('')?>/assets/images/blog-2.jpg" alt="blog" />
                            </div>
                            <div class="blog_content">
       ...
       <!--              <div class="col-lg-4 col-md-7">
                        <div class="single_blog mt-30">
                            <div class="blog_image">
                                <img src="<?php echo base_url('')?>/assets/images/blog-3.jpg" alt="blog" />
                            </div>
                            <div class="blog_content">
                                <span class="date"><span>23</span> Sept</span>

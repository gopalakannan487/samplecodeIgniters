                    ...
                    <div class="header_top_wrapper d-flex justify-content-center justify-content-md-between">
                        ...
                        <div class="header_top_login">
                            <ul>
                                ...
                                <li>
                                    <a href="<?php echo base_url('Welcome/logout')?>" class="main-btn"  ><i class="fa fa-user-o"></i> Log Out</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="header_menu"   >
                <div class="container">
                    <nav class="navbar navbar-expand-lg">
                        <a class="navbar-brand" href="<?php echo base_url('welcome/dashboard')?>">
                        ...
                        <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                            <ul class="navbar-nav m-auto">
                                <li>
                                    <a class="active" href="<?php echo base_url('welcome/dashboard')?>">Home <i class="fa fa-chevron-down"></i></a>
 
                                </li>
                                 <?php if(isset($_SESSION['user_id'])){?>
                                <?php if($_SESSION['user_id'] == 3){?>
                                <li>
                                    <a href="<?php echo base_url('welcome/billing')?>">Billing</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url('welcome/events')?>">Events <i class="fa fa-chevron-down"></i></a>
<!-- 
                                    <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="blog.html">Reports <i class="fa fa-chevron-down"></i></a>
